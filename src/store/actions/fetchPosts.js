...
export default function fetchPosts ({ activePostsOnly, afterTime, beforeTime, childPostInclusion = 'yes', collectionToFilterOut, context, cursor, filter, first, forCollection, offset, order, search, slug, sortBy, topic, topics, types }) {
