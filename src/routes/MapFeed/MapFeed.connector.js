...
import { fetchTopic, fetchCommunityTopic, fetchNetwork } from './MapFeed.store'
...
export function mapDispatchToProps (dispatch, props) {
  ...
  return {
    changeTab: tab => dispatch(changeQuerystringParam(props, 't', tab, 'all')), // these will be replaced by map specific filters
    changeSort: sort => dispatch(changeQuerystringParam(props, 's', sort, 'all')), // these will be replaced by map specific filters
    fetchTopic: () => {
