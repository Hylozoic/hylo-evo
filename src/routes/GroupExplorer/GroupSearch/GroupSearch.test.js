...
test('GroupSearch integration test', async () => {
  // const { getByText, getByRole, debug } = render(<GroupSearch />, container, providersWithStore)

  // expect(await getByText('Group Search')).toBeTruthy()
  // expect(await getByText('Test Group Title')).toBeTruthy()
  ...
  // expect(await getByText('Search input results')).toBeTruthy()

  const { queryByText, getByRole } = render(<GroupSearch />, container, providersWithStore)

  expect(await queryByText('Group Search')).toBeTruthy()
  expect(await queryByText('Test Group Title')).toBeTruthy()
