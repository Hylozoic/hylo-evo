...
class MemberProfile extends React.Component {
  ...
  render () {
    ...
    const contentDropDownItems = [
      { label: 'Overview', title: t("{{name}}s recent activity", { name: person.name }), component: RecentActivity },
      { label: 'Posts', title: t("{{name}}s posts", { person }), component: MemberPosts },
      { label: 'Comments', title: t("{{name}}s comments", { person }), component: MemberComments },
      { label: 'Upvotes', title: t("{{name}}s reactions", { person }), component: MemberVotes }
