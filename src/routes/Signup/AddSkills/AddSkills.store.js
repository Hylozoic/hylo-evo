export const MODULE_NAME = `ADD_SKILLS`
export const SIGNUP_ADD_SKILL = `${MODULE_NAME}_SIGNUP_ADD_SKILL`
export const SIGNUP_REMOVE_SKILL = `${MODULE_NAME}_SIGNUP_REMOVE_SKILL`
