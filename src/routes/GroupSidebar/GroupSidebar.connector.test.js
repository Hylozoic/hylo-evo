...
beforeAll(() => {
  ...
  session.Me.create({
    ...
    membershipCommonRoles: { items: [{ commonRoleId: 1, groupId: group.id, userId: 1, id: 1 }] }
  })
...
describe('mapStateToProps', () => {
  it('returns the right keys', () => {
    expect(mapStateToProps(state, { match: { params: { context: 'group', groupSlug: 'bar' } } })).toMatchSnapshot()
  })
})
