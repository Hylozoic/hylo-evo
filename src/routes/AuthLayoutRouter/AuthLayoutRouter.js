          ...
          {isDrawerOpen && (
            <Route
              path={[
                ...
                `/:context(groups)/:groupSlug/:view(custom)/:order/${OPTIONAL_POST_MATCH}`,
        ...
        <div styleName={cx('main', { 'map-view': isMapView, withoutNav })} onClick={handleCloseDrawer}>
          ...
          <Div100vh styleName={cx('center', { 'map-view': isMapView, collapsedState, withoutNav })} id={CENTER_COLUMN_ID}>
            ...
            <Switch>
              ...
              <Route path={`/:context(groups)/:groupSlug/:view(custom)/:order/${OPTIONAL_POST_MATCH}`} component={Stream} />
          ...
          <div styleName={cx('detail', { hidden: !hasDetail })} id={DETAIL_COLUMN_ID}>
            ...
            <Switch>
              ...
              <Route path={`/:context(groups)/:groupSlug/:view(custom)/:order/${POST_DETAIL_MATCH}`} component={PostDetail} />
