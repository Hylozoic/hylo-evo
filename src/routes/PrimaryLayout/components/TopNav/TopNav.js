...
export default class TopNav extends Component {
  render () {
    const { className, community, network, currentUser, logout, toggleDrawer, showLogoBadge, onClick, holochainMode } = this.props
    ...
    return <div styleName='topNavWrapper' className={className} onClick={onClick}>
      <div styleName='topNav' ref='topNav'>
        ...
        <div styleName='navIcons'>
          ...
          <MessagesDropdown holochainMode={holochainMode} renderToggleChildren={showBadge =>
