  ...
  render () {
    ...
    return <Div100vh styleName={cx('container', { 'map-view': isMapView, 'singleColumn': isSingleColumn, 'detailOpen': hasDetail })}>
      ...
      {!withoutNav && <>
        ...
        {!inIframe() && <TopNav styleName='top' onClick={this.closeDrawer} {...{ group, currentUser, routeParams, showMenuBadge, width }} />}
      </>}

      <div styleName={cx('main', { 'map-view': isMapView, 'inIframe': inIframe(), withoutNav })} onClick={this.closeDrawer}>
